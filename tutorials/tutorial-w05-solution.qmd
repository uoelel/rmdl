...
The 95% CrI of the effect of months in Germany on mean f0 when the attitude is polite and gender is female is \[-0.4, +0.1\], while it is \[-0.33, +0.2\] when the attitude is informal. The CrIs for gender male are much more uncertain. Given the level of uncertainty of the effect of months spent in Germany it is not wise to make any inference in relation to the research question and further comparisons will not be attempted. See @fig-f0-bm for the expected mean f0 based on the model.
